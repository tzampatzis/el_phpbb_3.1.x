...
$lang = array_merge($lang, array(
	...
	'ACCOUNT_INACTIVE'				=> 'Ο λογαριασμός σας δημιουργήθηκε. Αυτό το σύστημα συζητήσεων όμως απαιτεί να τον ενεργοποιήσετε, ένας κωδικός ενεργοποίησης στάλθηκε στη διεύθυνση ηλεκτρονικού ταχυδρομείου που υποβάλλατε. Παρακαλούμε ελέγξτε την ηλεκτρονική σας αλληλογραφία για περαιτέρω πληροφορίες.',
