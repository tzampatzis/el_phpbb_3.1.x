...
$lang = array_merge($lang, array(
	...
	'AND'							=> 'Και',
	'ARE_WATCHING_FORUM'			=> 'Έχετε επιλέξει να ενημερώνεστε για νέες δημοσιεύσεις σε αυτήν τη Δ. Συζήτηση.',
	...
	'AVATAR_PARTIAL_UPLOAD'			=> 'Το συγκεκριμένο αρχείο φορτώθηκε μόνον εν μέρει.',
	...
	'BAN_TRIGGERED_BY_EMAIL'=> 'Μια απαγόρευση έχει εκδοθεί στη διεύθυνση ηλεκτρονικού ταχυδρομείου σας.',
	'BAN_TRIGGERED_BY_IP'	=> 'Μια απαγόρευση έχει εκδοθεί στη διεύθυνση IP σας.',
	...
	'BROWSING_FORUM'		=> 'Μέλη σε αυτήν τη Δ. Συζήτηση: %1$s',
	...
	'CONFIRM_OPERATION'		=> 'Είστε σίγουρος (-η) ότι επιθυμείτε να διενεργήσετε αυτήν τη λειτουργία;',
	...
	'FROM'					=> 'από',
	'FSOCK_DISABLED'		=> 'Αυτή η λειτουργία δεν μπορεί να ολοκληρωθεί επειδή η <var>fsockopen</var> λειτουργία έχει απενεργοποιηθεί ή ο διακομιστής στον οποίο υποβλήθηκε το ερώτημα δεν μπορεί να βρεθεί.',
	...
	'FTP_FSOCK_ROOT_PATH_EXPLAIN'	=> 'Η διαδρομή του ριζικού φακέλου phpBB του συστήματος συζητήσεων σας.',
	...
	'INVALID_FEED_ATTACHMENTS'	=> 'Η συγκεκριμένη τροφοδότηση προσπάθησε να κατεβάσει συνημμένα με μη απόδεκτές παραμέτρους.',
	...
	'LOGIN_ERROR_PASSWORD_CONVERT'		=> 'Δεν ήταν δυνατή η μετατροπή του κωδικού πρόσβασης σας κατά την ενημέρωση του λογισμικού αυτού του συστήματος συζητήσεων. Παρακαλώ %sζητήστε έναν νέο κωδικό%s. Εάν συνεχίσετε να έχετε προβλήματα επικοινωνήστε με τον %sΔιαχειριστή του συστήματος συζητήσεων%s.',
	...
	'LOGIN_FORUM'						=> 'Για να προβάλετε ή να δημοσιεύσετε σε αυτήν τη Δ. Συζήτηση πρέπει να εισάγετε τον κωδικό της.',
	...
	'LOGIN_VIEWFORUM'					=> 'Το σύστημα συζητήσεων απαιτεί ότι πρέπει να είστε εγγεγραμμένο μέλος και να έχετε συνδεθεί για να δείτε τις δημοσιεύσεις σε αυτήν τη Δ. Συζήτηση',
	'LOGIN_EXPLAIN_EDIT'				=> 'Προκειμένου να κάνετε επεξεργασία δημοσιεύσεων σε αυτήν τη Δ. Συζήτηση πρέπει να είστε εγγεγραμμένο μέλος και να έχετε συνδεθεί.',
	...
	'MB'					=> 'MB',
	'MIB'					=> 'MiB',
	'MCP'					=> 'Πίνακας Ελέγχου Συντονιστή',
	'MCP_SHORT'				=> 'ΠΕΣ',
	'MEMBERLIST'			=> 'Μέλη',
	...
	'NOT_WATCHING_FORUM'		=> 'Δεν είστε πλέον συνδρομητής για ενημερώσεις σε αυτήν τη Δ. Συζήτηση.',
	...
	'NO_AUTH_OPERATION'			=> 'Δεν έχετε τα απαραίτητα δικαιώματα για να ολοκληρώσετε αυτήν τη λειτουργία.',
	...
	'NO_FEED_ENABLED'			=> 'Η τροφοδοσίες δεν είναι διαθέσιμες σε αυτό το σύστημα συζητήσεων.',
	...
	'NO_TOPICS'					=> 'Δεν υπάρχουν θέματα ή δημοσιεύσεις σε αυτήν τη Δ. Συζήτηση.',
	'NO_TOPICS_TIME_FRAME'		=> 'Δεν υπάρχουν θέματα μέσα σε αυτήν τη Δ. Συζήτηση για το επιλεγμένο χρονικό διάστημα.',
	...
	'POSTS_UNAPPROVED_FORUM'=> 'Τουλάχιστον μία δημοσίευση σε αυτήν τη Δ. Συζήτηση δεν έχει εγκριθεί.',
	'POST_BY_AUTHOR'		=> 'από',
	'POST_BY_FOE'			=> '<strong>%1$s</strong>, που είναι προς το παρόν στη λίστα αγνόησης σας, έκανε αυτήν τη δημοσίευση.',
	...
	'POST_DELETED_BY'		=> '<strong>%2$s</strong> διέγραψε τη δημοσίευση από <strong>%1$s</strong> την %3$s.',
	'POST_DELETED_BY_REASON'=> '<strong>%2$s</strong> διέγραψε τη δημοσίευση από <strong>%1$s</strong> την %3$s για τον παρακάτω λόγο: %4$s',
	...
	'REMOVE'					=> 'Διαγραφή',
	'REMOVE_INSTALL'			=> 'Παρακαλώ να διαγράψετε, να μετακινήσετε ή να μετονομάσετε τον κατάλογο εγκατάστασης (install) πριν χρησιμοποιήσετε το σύστημα συζητήσεων σας. Εάν αυτός ο κατάλογος εξακολουθεί να υπάρχει, μόνον ο Πίνακας Ελέγχου Διαχείρισης (ΠΕΔ) θα είναι προσβάσιμος.',
	'REPLIES'					=> 'Απαντήσεις',
	...
	'REPORT_POST'				=> 'Αναφέρετε αυτήν τη δημοσίευση',
	...
	'RULES_ATTACH_CANNOT'		=> '<strong>Δεν μπορείτε</strong> να επισυνάπτετε αρχεία σε αυτήν τη Δ. Συζήτηση',
	'RULES_DELETE_CAN'			=> '<strong>Μπορείτε</strong> να διαγράφετε τις δημοσιεύσεις σας σε αυτήν τη Δ. Συζήτηση',
	'RULES_DELETE_CANNOT'		=> '<strong>Δεν μπορείτε</strong> να διαγράφετε τις δημοσιεύσεις σας σε αυτήν τη Δ. Συζήτηση',
	'RULES_DOWNLOAD_CAN'		=> '<strong>Μπορείτε</strong> να μεταφορτώνετε συνημμένα αρχεία σε αυτήν τη Δ. Συζήτηση',
	'RULES_DOWNLOAD_CANNOT'		=> '<strong>Δεν μπορείτε</strong> να μεταφορτώνετε συνημμένα αρχεία σε αυτήν τη Δ. Συζήτηση',
	'RULES_EDIT_CAN'			=> '<strong>Μπορείτε</strong> να επεξεργάζεστε τις δημοσιεύσεις σας σε αυτήν τη Δ. Συζήτηση',
	'RULES_EDIT_CANNOT'			=> '<strong>Δεν μπορείτε</strong> να επεξεργάζεστε τις δημοσιεύσεις σας σε αυτήν τη Δ. Συζήτηση',
	'RULES_LOCK_CAN'			=> '<strong>Μπορείτε</strong> να κλειδώνετε τα θέματά σας σε αυτήν τη Δ. Συζήτηση',
	'RULES_LOCK_CANNOT'			=> '<strong>Δεν μπορείτε</strong> να κλειδώνετε τα θέματά σας σε αυτήν τη Δ. Συζήτηση',
	'RULES_POST_CAN'			=> '<strong>Μπορείτε</strong> να δημοσιεύετε νέα θέματα σε αυτήν τη Δ. Συζήτηση',
	'RULES_POST_CANNOT'			=> '<strong>Δεν μπορείτε</strong> να δημοσιεύετε νέα θέματα σε αυτήν τη Δ. Συζήτηση',
	'RULES_REPLY_CAN'			=> '<strong>Μπορείτε</strong> να απαντάτε σε θέματα σε αυτήν τη Δ. Συζήτηση',
	'RULES_REPLY_CANNOT'		=> '<strong>Δεν μπορείτε</strong> να απαντάτε σε θέματα σε αυτήν τη Δ. Συζήτηση',
	'RULES_VOTE_CAN'			=> '<strong>Μπορείτε</strong> να ψηφίζετε σε δημοψηφίσματα σε αυτήν τη Δ. Συζήτηση',
	'RULES_VOTE_CANNOT'			=> '<strong>Δεν μπορείτε</strong> να ψηφίζετε σε δημοψηφίσματα σε αυτήν τη Δ. Συζήτηση',
	...
	'SEARCH_FORUM'				=> 'Αναζητήστε σε αυτήν τη Δ. Συζήτηση…',
	...
	'SORRY_AUTH_READ'			=> 'Δεν είστε εξουσιοδοτημένοι να αναγνώσετε αυτήν τη Δ. Συζήτηση.',
	...
	'TOPIC'				=> 'Θέμα',
	'TOPICS'			=> 'Θέματα',
	'TOPICS_UNAPPROVED'	=> 'Τουλάχιστον ένα θέμα σε αυτήν τη Δ. Συζήτηση δεν έχει εγκριθεί.',
	...
	'UNWATCH_FORUM_CONFIRM'		=> 'Είστε σίγουρος (-η) ότι επιθυμείτε να διακόψετε τη συνδρομή από αυτήν τη Δ. Συζήτηση;',
	...
	'USER_CANNOT_READ'		=> 'Δεν μπορείτε να αναγνώσετε δημοσιεύσεις σε αυτήν τη Δ. Συζήτηση',
	'USER_POSTS'			=> array(
		1	=> '%d Δημοσίευση',
		2	=> '%d Δημοσιεύσεις',
	),
	...
	'VIEWING_CONTACT_ADMIN'		=> 'Επισκόπηση σελίδας επικοινωνίας',
	...
	'WATCH_FORUM_CONFIRM'	=> 'Είστε σίγουρος (-η) ότι επιθυμείτε συνδρομή σε αυτήν τη Δ. Συζήτηση;',
